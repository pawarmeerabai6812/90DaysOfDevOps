...
ip-172-31-17-175	         Hostname of the machine (AWS EC2 instance)
7.0.0-1008-aws	             Linux kernel version (AWS-optimized kernel)
#8-Ubuntu	                 Ubuntu kernel build number
SMP	                          Supports Symmetric Multi-Processing (multiple CPU cores)
PREEMPT	                       Preemptive kernel for better responsiveness
Fri Jun 19 00:15:35 UTC 2026	Date and time when the kernel was built
